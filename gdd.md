...
### 1. Этап 1: Подготовка и планирование (1 месяц)
- Написание GDD, закупка ассетов, настройка инструментов.

### 2. Этап 2: Прототипирование (1.5 месяца)
- Реализация базового геймплея, экономики и рейтинговой системы.

### 3. Этап 3: Разработка контента (2 месяца)
- Интеграция ассетов, настройка AI, добавление звука и музыки.

### 4. Этап 4: Полировка и оптимизация (1.5 месяца)
- Баланс геймплея, оптимизация графики, тестирование.

### 5. Этап 5: Публикация и маркетинг (1 месяц)
- Запуск игры в Steam, продвижение в соцсетях.
