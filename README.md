...
- [🎮 BORN TO HUNT GAME](#-born-to-hunt-game)
...
| **Пресса**        | Динамическая пресса, освещающая достижения игрока и других охотников.   |
| **Геймплей**      | Увлекательный геймплей который погружает в атмосферу охоты.             |
| **Собака**        | Игроку предстоит вырастить из щенка настоящего помощника в охоте.       |
...
- **Движение камеры за пулей:**  
  - При выстреле у игрока появляется возможность следить за фатальным выстрелом, камера будет следовать за полетом пули в замедленном времени. 
